    ...
    <>
      ...
      <main id="top" className="relative">
        <div id="hero-scroll-track" className="relative h-[220vh]">
          <div className="sticky top-0 flex h-screen flex-col items-start justify-center px-6 sm:px-10">
            <p className="font-mono text-xs uppercase tracking-[0.35em] text-accent-soft">
              Software &amp; AI engineer
            </p>
            <h1 className="mt-6 max-w-3xl font-serif-display text-5xl italic leading-[1.05] sm:text-7xl">
