...
const description =
  "Portfolio of Pranav Bonagiri, a self-taught software engineer who builds full-stack products end-to-end, solo — including Summit Tuition (£12k ARR in its first 6 weeks), Fly Brain Pong and QuickDraw AI.";
